  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed top-5 right-5 z-50 w-11 h-11 rounded-xl flex items-center justify-center border border-nidhi-border-subtle bg-nidhi-card/80 backdrop-blur-xl hover:border-nidhi-gold/30 transition-all shadow-lg"
      >
        <Bell className="w-4.5 h-4.5 text-nidhi-text-secondary" />
        {unreadCount > 0 && (
          <motion.span
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
